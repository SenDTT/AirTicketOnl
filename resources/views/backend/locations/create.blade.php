                ...
                <form action="{{ route('locations.store') }}" method="post">
                    ...
                    <div class="panel-body">
                        <div class="form-group col-md-12 {{ form_error_class('location_code', $errors) }}">
                            ...
                            <?= Form::text('location_code',null,['class'=>'form-control','placeholder'=>'Locations Code']); ?>
                        ...
                        <div class="form-group  col-md-12">
                            ...
                            <?= Form::text('location_name',null,['class'=>'form-control','placeholder'=>'Locations Name']); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <?= Form::text('description',null,['class'=>'form-control','placeholder'=>'Locations Name']); ?>
