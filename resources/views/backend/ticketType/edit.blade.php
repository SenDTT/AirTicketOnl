        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <?= Form::open([
                        'url' => URL::route('ticketType.update',$ticketType->id),
                        'method' =>'put',
                        'class'=>'form-add'
                    ])?>
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-12 {{ form_error_class('ticket_type_name', $errors) }}">
                                <label for="name">Tên loại vé</label>
                                <?= Form::text('ticket_type_name',$ticketType->ticket_type_name,['class'=>'form-control']); ?>
                                <p class="block-helper text-primary">Tên loại vé</p>
