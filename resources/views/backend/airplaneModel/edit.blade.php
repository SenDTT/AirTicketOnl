    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ URL::route('airplaneModel.update',$airplaneModels->id) }}" method="post">
                    <input type="hidden" name="_method" value="put">
                    {{ csrf_field() }}
                    <div class="form-group col-md-12 {{ form_error_class('model_code', $errors) }}">
                        <label for="arrive_date">Airplane Model Code</label>
                        <?= Form::text('model_code',$airplaneModels->model_code,['class'=>'form-control','placeholder'=>'Airplane Model Code']); ?>
                    ...
                    <div class="form-group col-md-12 {{ form_error_class('airplane_id', $errors) }}">
                        <label for="airplane_id">Airplane Name</label>
                        <?= Form::select('airplane_id',$airplanes,$airplaneModels->airplane_id,['class'=>'form-control select2']); ?>
