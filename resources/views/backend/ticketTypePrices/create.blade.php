        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form role="form" class="form-add" action="{{ URL::route('ticketTypePrices.store') }}"
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-12 {{ form_error_class('flight_id', $errors) }}">
                                ...
                                <?= Form::select('flight_id',$flights,null,['class'=>'form-control select2']); ?>
                            ...
                            <div class="form-group col-md-12 {{ form_error_class('ticket_type_id', $errors) }}">
                                ...
                                <?= Form::select('ticket_type_id',$ticketType,null,['class'=>'form-control select2']); ?>
