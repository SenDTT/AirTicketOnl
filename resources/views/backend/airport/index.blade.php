...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title"><i class="icon voyager-logbook"></i> Airport</h1>
                                            ...
                                            <div class="col-md-12">
                                                <table id="dataTable" class="table table-hover dataTable no-footer"
                                                    ...
                                                    @foreach($airports  as $key => $airport)
                                                        ...
                                                        <td>
                                                            {{ $airport->location->location_name }}
                                                        </td>

                                                        <td class="text-center" id="bread-actions">
                                                            <a href="javascript:;" title="Xóa" class="btn btn-sm btn-danger pull-right delete" data-id="{{ $airport->id }}"
                                                               id="delete-{{ $airport->id }}">
                                                                <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Xóa</span>
                                                            </a>
                                                            <a href="{{ URL::route('airports.edit',$airport->id) }}" title="Chỉnh sửa" class="btn btn-sm btn-primary pull-right edit">
