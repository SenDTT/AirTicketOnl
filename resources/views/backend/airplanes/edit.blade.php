            ...
            <div class="col-md-12">
                ...
                <form action="{{ URL::route('airplanes.update',$airplanes->id) }}" method="post">
                    ...
                    <div class="form-group col-md-12 {{ form_error_class('airplane_code', $errors) }}">
                        ...
                        <?= Form::text('airplane_code',$airplanes->airplane_code,['class'=>'form-control','placeholder'=>'Airplane Code']); ?>
                    ...
                    <div class="form-group col-md-12 {{ form_error_class('airplane_name', $errors) }}">
                        ...
                        <?= Form::text('airplane_name',$airplanes->airplane_name,['class'=>'form-control','placeholder'=>'Airplane Name']); ?>
