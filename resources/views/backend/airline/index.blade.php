...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title"><i class="icon voyager-logbook"></i> Airlines</h1>
                                                    ...
                                                    @foreach($airlines  as $key => $airline)
                                                        ...
                                                        <td class="text-center" id="bread-actions">
                                                            <a href="javascript:;" title="Xóa" class="btn btn-sm btn-danger pull-right delete" data-id="{{ $airline->id }}"
                                                               id="delete-{{ $airline->id }}">
                                                                <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Xóa</span>
                                                            </a>
                                                            <a href="{{ URL::route('airlines.edit',$airline->id) }}" title="Chỉnh sửa" class="btn btn-sm btn-primary pull-right edit">
