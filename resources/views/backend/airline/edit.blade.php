                    ...
                    <!-- form start -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group  col-md-12">
                                ...
                                <?= Form::text('airline_name',$airline->airline_name,['class'=>'form-control']); ?>
                            ...
                            <div class="form-group  col-md-12">
                                ...
                                <?= Form::text('carry_on',$airline->carry_on,['class'=>'form-control']); ?>
                            ...
                            <div class="form-group  col-md-12">
                                ...
                                <?= Form::text('check_in_baggage',$airline->check_in_baggage,['class'=>'form-control']); ?>
                            ...
                            <div class="form-group  col-md-12">
                                ...
                                <?= Form::text('airline_img',$airline->airline_img,['class'=>'form-control']); ?>
