        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                        <?= Form::open([
                            'url' => URL::route('routes.update',$route->id),
                            'method' =>'put',
                            'class'=>'form-add'
                        ])?>
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-12 {{ form_error_class('route_code', $errors) }}">
                                ...
                                <?= Form::text('route_code',$route->route_code,['class'=>'form-control']); ?>
                            ...
                            <div class="form-group col-md-12 {{ form_error_class('route_name', $errors) }}">
                                ...
                                <?= Form::text('route_name',$route->route_name,['class'=>'form-control']); ?>
                            ...
                            <div class="form-group col-md-12 {{ form_error_class('airport_id_from', $errors) }}">
                                ...
                                <?= Form::select('airport_id_from',$airports,$route->airport_id_from,['class'=>'form-control select2']); ?>
                            ...
                            <div class="form-group col-md-12 {{ form_error_class('airport_id_to', $errors) }}">
                                ...
                                <?= Form::select('airport_id_to',$airports,$route->airport_id_to,['class'=>'form-control select2']); ?>
